...
public class InvTweaksGuiShortcutsHelp extends GuiScreen {
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        drawCenteredString(
                obf.getFontRenderer(),
                StatCollector.translateToLocal("invtweaks.help.shortcuts.title"),
                width / 2,
                20,
                0xffffff); // Gui.drawCenteredString
        String clickLabel = StatCollector.translateToLocal("invtweaks.help.shortcuts.click");

        int y = height / 6 - 2;

        drawShortcutLine(
                StatCollector.translateToLocal("invtweaks.help.shortcuts.onestack"),
                "LSHIFT " + StatCollector.translateToLocal("invtweaks.help.shortcuts.or") + " RSHIFT + " + clickLabel,
                0x00FFFF00,
                y);
        y += 12;
        drawShortcutLine(
                "",
                buildUpOrDownLabel(
                        InvTweaksConfig.PROP_SHORTCUT_UP,
                        obf.getKeyBindingForwardKeyCode(),
        ...
        drawShortcutLine(
                "",
                buildUpOrDownLabel(
                        InvTweaksConfig.PROP_SHORTCUT_DOWN,
                        obf.getKeyBindingBackKeyCode(),
                        StatCollector.translateToLocal("invtweaks.help.shortcuts.backwards")) + " + " + clickLabel,
                0x00FFFF00,
                y);
        y += 12;
        drawShortcutLine(
                StatCollector.translateToLocal("invtweaks.help.shortcuts.oneitem"),
                config.getProperty(InvTweaksConfig.PROP_SHORTCUT_ONE_ITEM) + " + " + clickLabel,
                0x00FFFF00,
                y);
        y += 12;
        drawShortcutLine(
                StatCollector.translateToLocal("invtweaks.help.shortcuts.allitems"),
                config.getProperty(InvTweaksConfig.PROP_SHORTCUT_ALL_ITEMS) + " + " + clickLabel,
                0x00FFFF00,
                y);
        y += 12;
        drawShortcutLine(
                StatCollector.translateToLocal("invtweaks.help.shortcuts.everything"),
        ...
        drawShortcutLine(
                StatCollector.translateToLocal("invtweaks.help.shortcuts.hotbar"),
                "0-9 + " + clickLabel,
                0x0000FF33,
                y);
        y += 12;
        drawShortcutLine(
                StatCollector.translateToLocal("invtweaks.help.shortcuts.emptyslot"),
                StatCollector.translateToLocal("invtweaks.help.shortcuts.rightclick"),
                0x0000FF33,
                y);
        y += 12;
        drawShortcutLine(
                StatCollector.translateToLocal("invtweaks.help.shortcuts.drop"),
        ...
        drawShortcutLine(
                StatCollector.translateToLocal("invtweaks.help.shortcuts.craftall"),
                "LSHIFT, RSHIFT + " + clickLabel,
                0x00FF8800,
                y);
        y += 12;
        drawShortcutLine(
                StatCollector.translateToLocal("invtweaks.help.shortcuts.craftone"),
                config.getProperty(InvTweaksConfig.PROP_SHORTCUT_ONE_ITEM) + " + " + clickLabel,
                0x00FF8800,
                y);
        y += 19;
        ...
        drawShortcutLine(
                StatCollector.translateToLocal("invtweaks.help.shortcuts.selectconfig"),
                "0-9 + " + sortKeyName,
                0x0088FFFF,
                y);
        ...
        if (value != null) {
            drawString(
                    ...
                    value.contains("DEFAULT") ? "-"
                            : value.replaceAll(
                                    ", ",
                                    " " + StatCollector.translateToLocal("invtweaks.help.shortcuts.or") + " "),
                    width / 2 - 30,
                    y,
                    color); // drawString
        }
